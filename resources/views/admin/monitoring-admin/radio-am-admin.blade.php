                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="modal fade" id="editModal{{ $key }}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content ">
                                                    ...
                                                    <div class="modal-body">
                                                        <form name="add-radio-am-edit-form" id="add-radio-am-edit-form" method="POST" action="{{ url('api/radioAm/update/'.$ram->id)}}">
                                                            @csrf
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    <div class="col-sm">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-8 col-sm-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Nama stasiun radio</label>
                                                                                        <input type="text" class="form-control" id="nama_stasiun_radio" name="nama_stasiun_radio" value="{{ $ram->nama_stasiun_radio}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Lokasi Pemancar</label>
                                                                                        <input type="text" class="form-control" id="lokasi_pemancar" name="lokasi_pemancar" value="{{ $ram->lokasi_pemancar}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Frekuensi terukur mhz</label>
                                                                                        <input type="text" class="form-control" id="frekuensi_terukur_mhz" name="frekuensi_terukur_mhz" value="{{ $ram->frekuensi_terukur_mhz }}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Lokasi pemancar kecamatan</label>
                                                                                        <input type="text" class="form-control" id="lokasi_pemancar_kecamatan" name="lokasi_pemancar_kecamatan" value="{{ $ram->lokasi_pemancar_kecamatan}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Kabupaten / kota</label>
                                                                                        <input type="text" class="form-control" id="kab_kota" name="kab_kota" value="{{ $ram->kab_kota }}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Provinsi</label>
                                                                                        <input type="text" class="form-control" id="provinsi" name="provinsi" value="{{ $ram->provinsi }}">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-4 col-sm-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">No spt</label>
                                                                                        <input type="text" class="form-control" id="no_spt" name="no_spt" value="{{ $ram->no_spt}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Tanggal spt</label>
                                                                                        <input type="text" class="form-control" id="tanggal_spt" name="tanggal_spt" value="{{ $ram->tanggal_spt}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Kecamatan</label>
                                                                                        <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="{{ $ram->kecamatan}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Alamat</label>
                                                                                        <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $ram->alamat}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Latitude</label>
                                                                                        <input type="text" class="form-control" id="latitude" name="latitude" value="{{ $ram->latitude}}">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="message-text" class="col-form-label">Longitude</label>
                                                                                        <input type="text" class="form-control" id="longitude" name="longitude" value="{{ $ram->longitude}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            </div>
                                            ...
                                            <span>
                                                <a class="cursor-pointer fas fa-trash text-secondary" href="{{ url('api/radioAm/delete/'.$ram->id) }}"></a>
                                            </span>
                                        </td>
                                    </tr>
                                @endforeach
